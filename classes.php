<?php 
    ...
    if (!isset($_GET["kchordtauth"])) {
        header('location: tutors.php?error=invalid_tutor_id');
        exit();
    }
    ...
    <div class="container py-1 text-center text-lg-start my-3">
        <div class="row gx-lg-5 align-items-center mb-3">
            ...
            <div class="col-lg-12 mb-lg-0 position-relative">
                ...
                <div class="mb-4 position-relative al-countdown-wraper" style="text-align: center; color: #ffffff;">
                    <h2 class="display-5 fw-bold ls-tight" style="color: hsl(218, 81%, 95%)">Class Shop</h2>
                </div>
...
<script>
    $(document).ready(function() {
        const tutor_id = '<?php echo $tutor_id; ?>';
        loadClasses(tutor_id);
    });

    function loadClasses(tutor_id) {
        $('#loading').removeClass('d-none');

        $.ajax({
            url: 'ajax/class_process.php',
            type: 'POST',
            data: { 
                load_classes: true,
                tutor_id: tutor_id
                ...
                <div class="col-lg-6 mb-3">
                    <div class="card">
                        <div class="row g-0">
                            ...
                            <div class="col-md-4">
                                <img src="uploads/images/classes/${cls.image}" class="img-fluid rounded-start" alt="...">
                            </div>
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <hr>
                                    <p class="card-text">${cls.discription}</p>
                                    <div class="d-flex" style="gap:0.5rem;">
                                        <a href="lessons.php?kchordtauth=<?=$tutor_id ?>&kchordcauth=${cls.id}" class="btn btn-success btn-md w-100">View Lessons</a>
                                        <a href="tutors.php" class="btn btn-danger btn-md" style="background-color: #EE3A25 ;">back</a>
                                    </div>   
                                </div>
                            </div>
    ...
    function nodisplayClasses() {
        $('#classes-container').html(`
            <div class="position-relative" style="color:#fff;">
                <h5 class="card-title mb-3">Unfortunately, there are no Classes available at the moment.</h5>                       
                <a href="tutors.php" class="btn btn-danger btn-md">Back to Tutor</a>
            </div>`);
    }
</script>
