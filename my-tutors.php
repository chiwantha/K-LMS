...
<script>
    ...
    function loadtutors() {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: { load__available_tutors: true },
                ...
                <div class="col-lg-6 mb-3">
                    <div class="card">
                        <div class="row g-0">
                            ...
                            <div class="col-4">
                                <img src="uploads/images/tutor/${tutor.tutor_image}" class="img-fluid rounded-start" alt="...">
                            </div>

                            <div class="col-8">
                                <div class="card-body">
                                    <h5 class="card-title" style="font-size: 18px;">${tutor.tutor_name}</h5>
                                    <hr>
                                    <div class="d-flex" style="gap:0.5rem;">
                                        <a href="my-classes.php?kchordtauth=${tutor.tutor_id}" class="btn btn-success btn-md w-100">View Classes</a>
